module.exports.config = {
	...
	version: "1.0.5",
	hasPermssion: 1,
	credits: "Bùi Lê Bảo Luân UwU", //Tôn trọng người làm thì giữ nguyên credit nha :333
	description: "chửi cả box xong out",
...
module.exports.run = async function({ api, event, args }) {
	try {
		...
		var body = (args.length != 0) ? args.join(" ") : "Bắt Đầu Chửi Cái Box Ngu Này !", mentions = [], index = 0;
